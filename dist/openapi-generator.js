...
class OpenAPIGenerator {
    ...
    toOpenAPISchema(zodSchema, isNullable, defaultValue) {
        ...
        if ((0, zod_is_type_1.isZodType)(zodSchema, 'ZodNativeEnum')) {
            const { type, values, keys } = (0, enum_info_1.enumInfo)(zodSchema._def.values);
            if (type === 'mixed') {
                // enum Test {
                //   A = 42,
                //   B = 'test',
            ...
            const name = 'x-enum-varnames';
            return Object.assign(Object.assign({}, this.mapNullableType(type === 'numeric' ? 'integer' : 'string', isNullable)), { enum: values, default: defaultValue, [name]: keys });
        }
        if ((0, zod_is_type_1.isZodType)(zodSchema, 'ZodObject')) {
